...
public class PVMTest {
    ...
    public void testPVMManually() {
        ...
        Bundle C = Bundle.singleGoods(Sets.newHashSet(goodC));
        Bundle D = Bundle.singleGoods(Sets.newHashSet(goodD));
        Bundle AB = Bundle.singleGoods(Sets.newHashSet(goodA, goodB));
        Bundle AC = Bundle.singleGoods(Sets.newHashSet(goodA, goodC));
        Bundle AD = Bundle.singleGoods(Sets.newHashSet(goodA, goodD));
        Bundle BC = Bundle.singleGoods(Sets.newHashSet(goodB, goodC));
        Bundle BD = Bundle.singleGoods(Sets.newHashSet(goodB, goodD));
        Bundle CD = Bundle.singleGoods(Sets.newHashSet(goodC, goodD));
        Bundle ABC = Bundle.singleGoods(Sets.newHashSet(goodA, goodB, goodC));
        Bundle ABD = Bundle.singleGoods(Sets.newHashSet(goodA, goodB, goodD));
        Bundle ACD = Bundle.singleGoods(Sets.newHashSet(goodA, goodC, goodD));
        Bundle BCD = Bundle.singleGoods(Sets.newHashSet(goodB, goodC, goodD));
        Bundle ABCD = Bundle.singleGoods(Sets.newHashSet(goodA, goodB, goodC, goodD));
