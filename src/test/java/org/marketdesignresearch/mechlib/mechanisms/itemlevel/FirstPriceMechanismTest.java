...
public class FirstPriceMechanismTest {
    ...
    public void testSimpleFirstPriceAuction() {
        ...
        MechanismResult mechanismResult = new FirstPriceMechanism(singleItemBids).getMechanismResult();
        checkResult(mechanismResult, bidder2, bid2B);
    }

    @Test
    public void testFirstPriceAuctionNoBidder() {
        SingleItemBids bids = new SingleItemBids(new Bids());
        MechanismResult mechanismResult = new FirstPriceMechanism(bids).getMechanismResult();
    ...
    public void testFirstPriceAuctionSingleBidder() {
        ...
        SingleItemBids singleItemBids = new SingleItemBids(bids);
        MechanismResult mechanismResult = new FirstPriceMechanism(singleItemBids).getMechanismResult();
        checkResult(mechanismResult, bidder1, bid2B);
    }

    private void checkResult(MechanismResult mechanismResult, Bidder expectedWinner, BundleBid expectedWinningBid) {
