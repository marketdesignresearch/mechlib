...
public class OutcomeRuleScalerTest {
	...
	public void testScalerForCCGinORDomain() {
		...
		SimpleORDomain domain = new SimpleORDomain(ImmutableList.of(westBidder1, westBidder2, globalBidder),
				ImmutableList.of(west));
		MechanismFactory equalNorm = new VariableAlgorithmCCGFactory(new OrStarBlockingCoalitionFinderFactory(),
				ConstraintGenerationAlgorithm.STANDARD_CCG);
