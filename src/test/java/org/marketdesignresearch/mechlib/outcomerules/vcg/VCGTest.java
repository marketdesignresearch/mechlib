...
public class VCGTest {
	...
	public void testAuctionWrapper() {
		...
		SimpleXORDomain domain = new SimpleXORDomain(Lists.newArrayList(bidder1, bidder2, bidder3, bidder4),
		...
		((SimpleBidInteraction) auction.getCurrentInteraction(bidder4))
				.submitBid(new BundleExactValueBid(Sets.newHashSet(bid4)));
