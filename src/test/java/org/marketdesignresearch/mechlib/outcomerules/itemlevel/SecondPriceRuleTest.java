...
public class SecondPriceRuleTest {
    ...
    public void testSimpleSecondPriceAuctionWithWrapper() {
        ...
        Auction<BundleValuePair> auction = new Auction<>(domain, OutcomeRuleGenerator.SECOND_PRICE);
    ...
    public void testSecondPriceAuctionSingleBidder() {
        ...
        BundleValueBids bids = new BundleValueBids();
        bids.setBid(bidder1, new BundleValueBid(Sets.newHashSet(bid)));
        SingleItemBids singleItemBids = new SingleItemBids(bids);
        Outcome outcome = new SecondPriceRule(singleItemBids).getOutcome();
    ...
    public void testInvalidSingleGoodAuction() {
        ...
        BundleValueBids bidsOnTwoDifferentGoods = new BundleValueBids();
        ...
        BundleValueBids bidsOnComplexGood = new BundleValueBids();
