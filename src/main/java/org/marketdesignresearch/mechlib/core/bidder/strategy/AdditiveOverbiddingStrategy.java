 ...
 */
public class AdditiveOverbiddingStrategy<S extends ComparableStrategy<S>>
		implements MultiDimensionalComparableStrategy<AdditiveOverbiddingStrategy<S>> {
	public static final AdditiveOverbiddingStrategy<ShaveStrategy> TRUTHFUL = new AdditiveOverbiddingStrategy<>(
			ShaveStrategy.TRUTHFUL, BigDecimal.ZERO, ImmutableSet.of());
