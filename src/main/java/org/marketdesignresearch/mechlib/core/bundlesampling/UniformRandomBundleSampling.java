...
/**
 * This class samples a random bundle from a list of goods. Each good as a 50%
 * chance to be included in the bundle. Thus, if a good has a quantity of 2, the
 * chance that at least one of the individual goods are included is already at
 * 75%. No information is preserved, there is no guarantee that you can't get
