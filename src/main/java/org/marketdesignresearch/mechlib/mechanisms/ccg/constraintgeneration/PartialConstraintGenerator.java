...
interface PartialConstraintGenerator {
     ...
     * @param bids
     */
    void generateFirstRoundConstraints(Bids bids, MechanismResult referencePoint, Map<Good, PotentialCoalition> goodToBidderMap, CorePaymentRule corePaymentRule);
