...
public interface MachineLearningComponent<T extends BundleValueBids<?>> {
	...
	/**
	 * Learns the value functions with the given bids and returns a allocation inferrer 
	 * (i.e. the component that generate WDP problem for different economies based on
	 * the learned value functions).
	 * 
