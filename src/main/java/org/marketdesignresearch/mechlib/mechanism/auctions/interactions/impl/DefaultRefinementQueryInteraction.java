...
public class DefaultRefinementQueryInteraction extends DefaultInteraction<BundleBoundValueBid>
		implements RefinementQuery {
	...
	protected DefaultRefinementQueryInteraction(UUID bidder, Set<RefinementType> refinementTypes,
	...
	public DefaultRefinementQueryInteraction(UUID bidder, Auction<BundleBoundValueBids> auction,
			Set<RefinementType> refinementTypes, Bundle provisionalAllocation, Prices prices,
