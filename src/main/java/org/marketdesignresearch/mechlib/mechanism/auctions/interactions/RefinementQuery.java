...
/**
 * Bidders are asked to refine their active bids and sumbit new (possible update)
 * bids for all bundles in {@link #getLatestActiveBid()} such that they comply with
 * the specified activity rules ({@link #getRefinementTypes()}).
 * 
