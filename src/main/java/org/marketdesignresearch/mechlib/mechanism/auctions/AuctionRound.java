...
/**
 * An AuctionRound holds the state (i.e. the result) of an AuctionRound. It may
 * also hold the internal state of an AuctionPhase such that the Auction can be
 * rolled back to any AuctionRound and continue at exactly the same state
 * before.
 * 
