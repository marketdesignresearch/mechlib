...
/**
 * Predicts the efficient allocation based on a model trained with previous
 * bids.
 * 
...
public interface MachineLearningAllocationInferrer {
	 ...
	 *                        allocations).
	 * @return the predicted efficient allocation for this economy for the limited
	 *         set of feasible allocation.
	 */
