...
public interface Interaction {
	...
	/**
	 * Set the auction in this interaction. This method is mainly used to enable the
	 * persistence of an auction by avoiding circular reference persistence. This
	 * method should be called when deserializing the model.
	 * 
	...
	/**
	 * Submits the proposed bid (i.e. the bid generated by a bidders strategy
	 * {@link InteractionStrategy}).
	 */
