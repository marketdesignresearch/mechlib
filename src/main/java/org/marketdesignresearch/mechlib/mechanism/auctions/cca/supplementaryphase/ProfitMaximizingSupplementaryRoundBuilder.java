...
public class ProfitMaximizingSupplementaryRoundBuilder extends AuctionRoundBuilder<BundleValuePair> {

	private final Map<UUID, ProfitMaxQuery> interactions;

	public ProfitMaximizingSupplementaryRoundBuilder(Map<UUID, ProfitMaxQuery> interactions, Auction<BundleValuePair> auction) {
		super(auction);
