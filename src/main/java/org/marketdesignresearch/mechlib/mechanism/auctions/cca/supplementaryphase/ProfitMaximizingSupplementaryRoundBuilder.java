...
public class ProfitMaximizingSupplementaryRoundBuilder extends AuctionRoundBuilder<BundleExactValueBids> {
	...
	public ProfitMaximizingSupplementaryRoundBuilder(Map<UUID, ProfitMaxQuery> interactions,
	...
	public AuctionRound<BundleExactValueBids> build() {
		return new ProfitMaximizingSupplementaryRound(this.getAuction(), this.collectBids(),
				this.interactions.values().iterator().next().getPrices());
