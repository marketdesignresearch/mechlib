...
public class ORWinnerDetermination extends BidBasedWinnerDetermination {
    ...
    public ORWinnerDetermination(BundleValueBids<BundleValuePair> bids) {
        super(bids);
        winnerDeterminationProgram = createWinnerDeterminationMIP(bids);
    }

    protected MIPWrapper createWinnerDeterminationMIP(BundleValueBids<? extends BundleValuePair> bids) {
