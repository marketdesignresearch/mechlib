...
public class StandardCCGConstraintGenerator implements PartialConstraintGenerator {
	...
	/**
	 * 
	 * See Day, Raghavan 2007 for detailed explanation. The Winners need to offer
	 * the auctioneer a higher value than the blocking coalition can offer. Any
	 * increase in the payments of W /\ C will increase both the coalition's value
	...
	public void generateConstraint(CorePaymentRule corePaymentRule, Graph<PotentialCoalition, DefaultEdge> graph,
		...
		BlockedBidders blockedBidders = new BlockedBidders(lastResult.getWinners(),
				blockingCoalition.getPotentialCoalitions(), coalitionalValue);
